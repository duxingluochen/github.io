const primaryMenus = [
    { id: "tools", name: "🔧 实用工具", icon: "fas fa-wrench" },
    { id: "ai-dev", name: "🤖 AI与开发", icon: "fas fa-microchip" },
    { id: "media", name: "🎬 影视娱乐", icon: "fas fa-film" },
    { id: "read-music", name: "📖 阅读与音乐", icon: "fas fa-headphones" },
    { id: "study-life", name: "🌟 学习生活", icon: "fas fa-graduation-cap" }
];
